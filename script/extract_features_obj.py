...
class FeatureExtractor:
    ...
    def get_parser(self):
        ...
        # parser.add_argument(
        #     "--output_folder", type=str, default="/srv/share/ykant3/vilbert-mt/features/obj/train/", help="Output folder"
        # )
        #
        parser.add_argument(
            "--output_folder", type=str, default="/srv/share/ykant3/vilbert-mt/features/obj/test/", help="Output folder"
        )

        # parser.add_argument("--image_dir", type=str, default="/srv/share/ykant3/pythia/dataset_images/train_images/", help="Image directory or file")
