...
def debug_sampler(sampler):
    ...
    # Counter:
    # For first batch with batch_size = 208 and init_size = 8
    # ({1: 42579, 2: 20555, 3: 9362, 4: 3915, 5: 1598, 6: 599, 7: 240, 8: 81, 9: 33, 10: 13, 11: 3, 13: 2, 12: 2})
    # Total Samples used in one epoch: 78982
    # Total Samples: 141857, Unused Samples: 62875 [44.32%]
    # --
    # For first batch with batch_size = 208 and init_size = 8
    # ({1: 42579, 2: 20555, 3: 9362, 4: 3915, 5: 1598, 6: 599, 7: 240, 8: 81, 9: 33, 10: 13, 11: 3, 13: 2, 12: 2})
    # Total Samples used in one epoch: 78982
    # Total Samples: 141856, Unused Samples: 62874 [44.32%]
    # --
    # [(1, 135), (2, 644), (3, 1528), (4, 2463), (5, 3426), (6, 4131), (7, 4375), (8, 4394), (9, 4592), (10, 4481),
    # (11, 4385), (12, 4331), (13, 4018), (14, 3982), (15, 3886), (16, 3854), (17, 3686), (18, 3526), (19, 3501),
    # (20, 3323), (21, 3252), (22, 3094), (23, 3029), (24, 2828), (25, 2864), (26, 2621), (27, 2599), (28, 2410),
    # (29, 2426), (30, 2297), (31, 2243), (32, 2079), (33, 2034), (34, 1945), (35, 1936), (36, 1780), (37, 1741),
    # (38, 1706), (39, 1618), (40, 1556), (41, 1491), (42, 1465), (43, 1366), (44, 1242), (45, 1247), (46, 1238),
    # (47, 1081), (48, 1094), (49, 1043), (50, 955), (51, 927), (52, 904), (53, 740), (54, 728), (55, 691), (56, 673),
    # (57, 637), (58, 582), (59, 546), (60, 479), (61, 494), (62, 454), (63, 458), (64, 388), (65, 381), (66, 367),
    # (67, 348), (68, 343), (69, 313), (70, 295), (71, 277), (72, 267), (73, 258), (74, 211), (75, 209), (76, 189),
    # (77, 197), (78, 166), (79, 173), (80, 148), (81, 141), (82, 146), (83, 116), (84, 104), (85, 101), (86, 105),
    # (87, 98), (88, 95), (89, 71), (90, 101), (91, 69), (92, 65), (93, 68), (94, 63), (95, 55), (96, 55), (97, 62),
    # (98, 44), (99, 48), (100, 53), (101, 41), (102, 32), (103, 34), (104, 29), (105, 35), (106, 31), (107, 22),
    # (108, 34), (109, 20), (110, 33), (111, 13), (112, 20), (113, 20), (114, 20), (115, 17), (116, 19), (117, 14),
    # (118, 11), (119, 11), (120, 14), (121, 7), (122, 15), (123, 9), (124, 7),  (125, 12), (126, 4),
    # (127, 10), (128, 6), (129, 4), (130, 5), (131, 3), (132, 5), (133, 5), (134, 1), (135, 1), (136, 1),
    # (137, 1), (138, 1), (139, 1), (141, 2), (147, 1), (149, 2), (152, 1), (155, 1)]


    import pdb
    pdb.set_trace()

    for question_id in sampler:
        counter[question_id] += 1

    for val, freq in counter.most_common():
        freq_counter[freq] += 1

    print("Frequencies:", freq_counter)
    print("Samples Used: ")